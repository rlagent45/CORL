...
parser.add_argument('--epochs', default=100, type=int, help="Number of epochs to do over dataset")
parser.add_argument('--dataset_size', default=128000, type=int, help="number of samples in dataset")
parser.add_argument('--vis_iter', default=1, type=int, help="Log output will be displayed every vis_iter epoch")
parser.add_argument('--save_iter', default=10, type=int, help="Model will be saved every save_iter epoch")
parser.add_argument('--sigma', default=0.01, type=float, help="Exploration region for ES")
parser.add_argument('--lr', default=1e-6, type=float, help="learning rate")
parser.add_argument('--problem_size', default=100, type=int, help="number of nodes in problem")
parser.add_argument('--batch_size', default=64, type=int, help="samples in batch")
parser.add_argument('--load_source', '-l', default=None, type=str, help="path to source model")
parser.add_argument('--save_hrs', nargs='+', type=int, help="hrs for which to save model")
parser.add_argument('--save_dir', default='../models/att_evo', type=str, help="directory to save checkpoints and model to")
